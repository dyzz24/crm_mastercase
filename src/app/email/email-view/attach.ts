export const attachers = [
    {title: 'Акт приемки от ООО "Строй-Монтаж" по договору № А-711-02-11 от 02.22.2018 подписанный С.О', size: '7kb', type: 'doc'},
    {title: 'sdasdsada.xls', size: '12kb', type: 'xls'}, {title: 'ada.pdf', size: '22kb', type: 'pdf'},
